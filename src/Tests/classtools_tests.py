...
class Test_TaggedType_with_attrs(unittest.TestCase):
    ...
    def test_conv(self):
        ...
        self.assertEqual(self.ConvClass.__tags__, clsdict(test=('c',), empty=()))
    ...
    def test_inheritance(self):
        ...
        self.assertEqual(ch.__class__.__tags__, clsdict(test=('c', 'g'), empty=('k',)))
...
class Test_AttrTagging(unittest.TestCase):
    ...
    def test_tagging(self):
        c = self.Tagged()
        self.assertEqual(self.Tagged.__tags__, clsdict(test=('c',)))
    ...
    def test_inheritance(self):
        ch = self.ChildTagged()
        self.assertEqual(self.ChildTagged.__tags__, clsdict(test=('c', 'g', '_h'), empty=('k',), new=('m', 'n')))
    ...
    def test_overrides(self):
        ...
        self.assertEqual(self.OverridingChild.__tags__,
                         clsdict(test=('c', 'g', '_h'), empty=('k',), new=('m', 'n'), override_class_var=('f', 'o')))
    ...
    def test_multiple_inheritance_simple(self):
        ...
        self.assertEqual(self.MultipleInheritanceEmptyChild.__tags__, clsdict(
                test=('g', 'r', 's', 'c', '_h'), empty=('k',), new=('m', 'n'),
    ...
    def test_multiple_inheritance_extended(self):
        ...
        self.assertEqual(self.MultipleInheritanceEmptyChild.__annotations__,
                         dict(c='int', g='ClassVar', m1='str', m2='str'))
        self.assertTrue(hasattr(self.MultipleInheritanceEmptyChild, 'Nested'))
