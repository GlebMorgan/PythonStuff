...
# CONSIDER: provide a 'parent' variable in dict returned in __prepare__ referencing to parent class object;
#           this way inner classes and variables may be visible in child class, which makes sense

# CONSIDER: Add tagging via 'with' block

# CONSIDER: implement lookups diving into mro classes when searching for defaults to initialize slots
